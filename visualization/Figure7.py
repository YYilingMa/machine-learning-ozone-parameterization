# plot Figure 7 in the manuscript
...
True_pi_file = xr.open_dataset(Infilepath+'fullChem_temp_piCTRL_1990_2009_UKESM_timmean.nc',decode_times=True) # 1960-1-1 to 2009-12-30
Temp_true_pi = True_pi_file['temp'].squeeze()
Onl_pi_file = xr.open_dataset(Infilepath+'mloz_ozone_piCTRL_2030_2049_UKESM_timmean.nc',decode_times=True) # 2000-1-1 to 2049-12-30
Temp_onl_pi = Onl_pi_file['temp'].squeeze()
True_4CO2_file = xr.open_dataset(Infilepath+'fullChem_temp_4CO2_1990_2009_UKESM_timmean.nc',decode_times=True) # 1960-1-1 to 2009-12-30
Temp_true_4CO2 = True_4CO2_file['temp'].squeeze()
Onl_4CO2_file = xr.open_dataset(Infilepath+'mloz_ozone_4CO2_2030_2049_UKESM_timmean.nc',decode_times=True) # 2000-1-1 to 2049-12-30
...
mloz_pi_file = xr.open_dataset(mloz_path1+"mloz_piCTRL_1852_1881_ICON_timmean.nc")
mloz_4co2_file = xr.open_dataset(mloz_path2+"mloz_4CO2_1852_1881_ICON_timmean.nc")
